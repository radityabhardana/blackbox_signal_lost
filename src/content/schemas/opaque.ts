...
export const claimSlotDefinitionSchema = z.record(z.unknown()); // docs/09 §13 — owns: BBX-080 conclusion contract
export const disclosureChoiceDefinitionSchema = z.record(z.unknown()); // docs/09 §13 — owns: BBX-080 conclusion contract
